# Ruby on Rails White Belt

Welcome to the Ruby on Rails White Belt! This curriculum is for those who are new to web development or the Rails framework.

Ruby on Rails (often just "Rails") is a powerful web application framework built on the Ruby programming language. It follows the "convention over configuration" philosophy, which means it makes assumptions about what you need to get started, allowing you to build powerful applications with less code.

Since Rails is built on Ruby, this white belt will start with the absolute basics of the Ruby language itself before moving into the core concepts of the Rails framework.
